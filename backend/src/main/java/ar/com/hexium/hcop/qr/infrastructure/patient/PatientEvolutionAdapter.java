...
/** Nombre de bean explícito: {@code workflow.infrastructure.patient.PatientEvolutionAdapter}
 * tiene el mismo simple name — sin esto Spring falla el arranque con
 * {@code ConflictingBeanDefinitionException} (bug real, encontrado en Docker, F3.4). */
@Component("qrPatientEvolutionAdapter")
