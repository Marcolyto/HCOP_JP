...
@RestControllerAdvice(assignableTypes = TreatmentWorkflowController.class)
public class WorkflowFailureAdvice {
  @ExceptionHandler(WorkflowFailure.class)
  ResponseEntity<ApiErrorResponse> handle(WorkflowFailure failure) {
