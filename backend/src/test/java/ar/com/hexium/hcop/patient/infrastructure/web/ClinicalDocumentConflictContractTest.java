...
class ClinicalDocumentConflictContractTest {
  private final PostgresPatientDocumentRepository repository = mock(PostgresPatientDocumentRepository.class);
  ...
  void setUp() {
    ...
    PatientDocumentApplicationService service = new PatientDocumentApplicationService(
        new PatientDocumentStoreAdapter(repository, mapper, mock(HcopProperties.class), clock));
    ...
    mvc = MockMvcBuilders.standaloneSetup(controller)
        .setControllerAdvice(new ApiExceptionHandler(), new PatientFailureAdvice())
        .build();
  }
